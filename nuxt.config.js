export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: 'og:image', name: 'og:image', content: 'https://austin-caron-reagan-sheets-default.layer0.link/logo_socials.png' },
      ...
      { hid: 'twitter:image', name: 'twitter:image', content: 'https://austin-caron-reagan-sheets-default.layer0.link/logo_socials.png' },
